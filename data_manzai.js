...
const manzaiData = {
    ...
    'mie': {
        scenario: [
            { type: 'dialogue', speaker: '三重', text: 'はいどうもー！<br>三重県でーす！' },
            { type: 'dialogue', speaker: '山形', text: '山形県で〜す' },
            { type: 'dialogue', speaker: '山形', text: '今日は県の形だけでも<br>覚えて帰ってくださ〜い' },
            { type: 'dialogue', speaker: '三重', text: '三重県といえば、やっぱり<br>「お伊勢さん」やな〜' },
            { type: 'dialogue', speaker: '三重', text: '日本人の心のふるさと！<br>感謝を伝える神聖な場所やに' },
            { type: 'dialogue', speaker: '山形', text: 'うんうん<br>感謝の心って大事だよね' },
            { type: 'dialogue', speaker: '山形', text: '山形でも<br>感謝を伝えるために神社を建てたんだ' },
            { type: 'dialogue', speaker: '三重', text: 'おっ、信心深いなぁ<br>どんな神様をお祀りしとるん？' },
            ...
            { type: 'dialogue', speaker: '三重', text: '・・・え？空気？' },
            {
                ...
                tsukkomi: [
                    ...
                    { text: "何に向かって<br>手を合わせるん！？", 
                        point: 1, type: ['t', 'p'], 
                        reaction: '三重「見えやんもの拝むって<br>難易度高くない！？」' },
                    { text: "エコロジーで<br>素敵やな", 
                        point: 0, type: ['v'], 
            ...
            { type: 'dialogue', speaker: '三重', text: 'その感覚はわかるよ' },
            ...
            { type: 'dialogue', speaker: '三重', text: 'ツッコミどころが多いってことは<br>ようわかったわ' },
            { type: 'dialogue', speaker: '山形', text: 'それが山形の魅力だ！' },
