...
'tokyo': {
    ...
    'ehime': {
        scenario: [
            ...
            { type: 'dialogue', speaker: '愛媛', text: '冷やしシャンプー・・・？<br>のぼせた時に使うん？' },
            { type: 'dialogue', speaker: '山形', text: 'ううん<br>床屋さんでやってもらうんだ' },
            { type: 'dialogue', speaker: '愛媛', text: '床屋さんで！？<br>頭が凍ってしまいそうやね・・・' },
