...
const manzaiData = {
    ...
    'ishikawa': {
        scenario: [
            ...
            { type: 'dialogue', speaker: '山形', text: '山形県で〜す' },
            { type: 'dialogue', speaker: '山形', text: '今日は県の形だけでも<br>覚えて帰ってくださ〜い' },
            { type: 'dialogue', speaker: '石川', text: '石川といえば〜、やっぱり「金箔」やわ<br>国内生産量の99％を占めとるげん〜' },
            { type: 'dialogue', speaker: '石川', text: '加賀百万石の歴史が詰まった<br>豪華絢爛な伝統工芸が自慢ねん' },
            ...
            { type: 'dialogue', speaker: '石川', text: 'まあ、食文化も大事やけど〜<br>石川は「アート」も盛んねんよ' },
            { type: 'dialogue', speaker: '石川', text: '「金沢21世紀美術館」なんかは<br>世界的にも有名やし' },
            { type: 'dialogue', speaker: '石川', text: 'プールの中に人がおるような作品とか〜<br>幻想的な現代アートがいっぱいねん' },
            ...
            { type: 'dialogue', speaker: '石川', text: '気候への備えはどうしとれん？' },
            { type: 'dialogue', speaker: '石川', text: '石川には「弁当忘れても傘忘れるな」<br>っていう言葉があるげん' },
            { type: 'dialogue', speaker: '石川', text: '雨や雪が多いし〜<br>準備を怠らん、慎み深い県民性ねん' },
            ...
            { type: 'dialogue', speaker: '石川', text: 'ツッコミどころが多いってことは<br>よけわかったわ' },
            { type: 'dialogue', speaker: '山形', text: 'それが山形の魅力だ！' },
            { type: 'dialogue', speaker: '石川', text: '・・・・・・' },
            { type: 'dialogue', speaker: '石川', text: 'それでいいんけ！' },
            { type: 'ending', speaker: 'both', text: 'どうも<br>ありがとうございました〜！' },
        ]
    },
    ...
    'fukui': {
        scenario: [
            ...
            { type: 'dialogue', speaker: '福井', text: '全47都道府県<br>幸福度ランキング1位！' },
            ...
            { type: 'dialogue', speaker: '福井', text: '新しい名前？<br>「ラーメン県」とかけ？' },
            { type: 'dialogue', speaker: '山形', text: '山形県改め・・・' },
            {
                type: 'prompt', speaker: '山形', text: '「ラーメン県そば王国やまがた」だよ',
                tsukkomi: [
                    { text: "麺類に<br>全振りしすぎやろ！", 
                        point: 1, type: ['t', 'p'], 
                        reaction: '福井「もう『麺県』でええやん！<br>欲張りすぎやわ！」' },
                    { text: "県の中に<br>国作るな！", 
                        point: 3, type: ['t', 'p', 'v'], 
                        reaction: '福井「せめて逆だろ！<br>行政区分がめちゃくちゃやざ！」' },
                    { text: "美味しそうな<br>名前やなぁ", 
                        point: 0, type: ['v'], 
                        reaction: '福井「お腹空いてくる名前やの<br>一回食べてみたいわ」' }
                ]
            },
            { type: 'dialogue', speaker: '福井', text: '・・・まあ、「王国」っていうなら<br>福井も負けてへんよ' },
            { type: 'dialogue', speaker: '福井', text: '福井は「恐竜王国」！' },
            { type: 'dialogue', speaker: '福井', text: '国内で見つかる化石の多くが<br>福井産なんやって' },
            { type: 'dialogue', speaker: '福井', text: '駅前にも動く恐竜がおるし<br>まさに王国の風景やね' },
            { type: 'dialogue', speaker: '山形', text: '恐竜ぁ<br>ロマンがあるね' },
            { type: 'dialogue', speaker: '山形', text: '山形には“ケサランパサラン”っていう<br>不思議な生物がいるよ' },
            { type: 'dialogue', speaker: '福井', text: 'ケサランパサラン？<br>あの白い毛玉みたいなやつけ？' },
            { type: 'dialogue', speaker: '山形', text: 'そうそう' },
            { type: 'dialogue', speaker: '福井', text: 'でもそいつ<br>未確認生物やが' },
            {
                type: 'prompt', speaker: '山形', text: 'うん、でも<br>水族館に普通に展示されてるよ',
                tsukkomi: [
                    { text: "実物見てみたいわ", 
                        point: 0, type: ['p'], 
            ...
            { type: 'dialogue', speaker: '福井', text: '山形は<br>希少なもんへの扱いが軽いんやな' },
            { type: 'dialogue', speaker: '福井', text: '福井は恐竜を盛り上げるために' },
            { type: 'dialogue', speaker: '福井', text: '日本一の高さの恐竜モニュメントを<br>作ったんやって' },
            { type: 'dialogue', speaker: '福井', text: 'やっぱりシンボルは<br>デカければデカいほどみんなに伝わるし' },
            { type: 'dialogue', speaker: '福井', text: 'かっこええやろ？' },
            ...
            { type: 'dialogue', speaker: '山形', text: '「日本一の芋煮会フェスティバル」<br>って言って' },
            ...
            { type: 'dialogue', speaker: '福井', text: '鍋が6.5メートル！？<br>どうやって混ぜるんや、そんなもん' },
            {
                ...
                promptText: '直径6.5メートルの鍋と<br>バックホーで調理するんだよ',
                tsukkomi: [
                    { text: "巨大化すればいいと<br>思ってる！？", 
                        point: 3, type: ['t', 'p', 'v'], 
                        reaction: '福井「発想が突飛すぎんか！？<br>もっと繊細に料理しろ！」' },
                    { text: "迫力が<br>すごそうやの", 
                        point: 0, type: ['v'], 
                        reaction: '福井「一度に3万食も作れるなら<br>みんなお腹いっぱいになれるの」' },
                    { text: "重機を調理器具に<br>するなよ！", 
                        point: 1, type: ['p', 't'], 
                        reaction: '福井「それ専用の工事現場やが！<br>衛生面とか大丈夫なんか！？」' },
                ]
            },
            { type: 'dialogue', speaker: '山形', text: 'どう？<br>山形のこと、だいたいわかった？' },
            { type: 'dialogue', speaker: '石川', text: 'う〜ん<br>とりあえず・・・' },
            ...
            { type: 'dialogue', speaker: '福井', text: 'それでいいんかい！' },
            { type: 'ending', speaker: 'both', text: 'どうも<br>ありがとうございました〜！' },
        ]
    },
    ...
    'osaka': {
        scenario: [
            ...
            { type: 'dialogue', speaker: '大阪', text: '道頓堀の看板とか<br>おばちゃんのヒョウ柄みたいな' },
            { type: 'dialogue', speaker: '大阪', text: 'インパクトあるやつ頼むで！' },
    ...
    'wakayama': {
        scenario: [
            ...
            { type: 'dialogue', speaker: '山形', text: '愛の深さなら<br>山形はやっぱりラーメンかな' },
            ...
            { type: 'dialogue', speaker: '和歌山', text: '・・・<br>ん・・・？' },
            {
                ...
                tsukkomi: [
                    ...
                    { text: "なんでもかんでも<br>冷やしすぎやろ！", 
                        point: 3, type: ['t', 'p', 'v'], 
                        reaction: '和歌山「そのうち冷やし山形とか<br>言い出すんちゃうか！？」' },
            ...
            { type: 'dialogue', speaker: '和歌山', text: '和歌山には、窮地を救った<br>立役者がおるんよ' },
            { type: 'dialogue', speaker: '和歌山', text: '猫の「たま駅長」や！' },
            ...
            { type: 'dialogue', speaker: '山形', text: '水槽いっぱいのクラゲを見て<br>癒やされたあと・・・' },
            { type: 'dialogue', speaker: '山形', text: 'その足ですぐ売店に行って<br>アレを食べるのが最高なんだ' },
            { type: 'dialogue', speaker: '和歌山', text: 'アレ？' },
            {
                type: 'prompt', speaker: '山形', text: '刻んだクラゲが入った「クラゲアイス」',
                promptText: 'クラゲを見て癒されたあと<br>「クラゲアイス」を食べるのが最高なんだ',
                tsukkomi: [
    ...
    'saga': {
        scenario: [
            ...
            { type: 'dialogue', speaker: '佐賀', text: '見た目がおっとろしかけん<br>「有明海のエイリアン」て呼ばれるっちゃん' },
            { type: 'dialogue', speaker: '山形', text: 'へぇ〜<br>エイリアンかぁ' },
            { type: 'dialogue', speaker: '佐賀', text: 'でも干物にしたり刺身にしたり<br>食べると美味しかとよ' },
            ...
            { type: 'dialogue', speaker: '佐賀', text: '佐賀は海もよかけど<br>空もすごかとよ' },
            { type: 'dialogue', speaker: '佐賀', text: '「佐賀インターナショナルバルーンフェスタ」！' },
            { type: 'dialogue', speaker: '佐賀', text: 'アジア最大級の熱気球大会で<br>バルーンが空を埋め尽くすっちゃん' },
